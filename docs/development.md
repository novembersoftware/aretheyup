...
3. Use `go run main.go seed --count 25 --clear` when you need a realistic local dataset.
4. Use `go run main.go manage` to create, edit, or delete services and probe configuration.
